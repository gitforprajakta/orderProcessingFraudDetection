...
class PlatformStack extends cdk.Stack {
    constructor(scope, id, props) {
        ...
        const notificationEmails = this.node.tryGetContext("notificationEmails") || [];
        notificationEmails.forEach((email, index) => {
            if (email && email.includes("@")) {
                ...
                cdk.Annotations.of(this).addWarning(`notificationEmails[${index}] is not a valid email: ${email}`);
            }
        });
