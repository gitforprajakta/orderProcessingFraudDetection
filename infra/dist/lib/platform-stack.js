...
class PlatformStack extends cdk.Stack {
    constructor(scope, id, props) {
        ...
        const productsLambdaName = "OrderProcessingFraudDetection-ProductsLambda";
        const cartLambdaName = "OrderProcessingFraudDetection-CartLambda";
        const myOrdersLambdaName = "OrderProcessingFraudDetection-MyOrdersLambda";
        ...
        const stockRestoreLambdaName = "OrderProcessingFraudDetection-StockRestoreLambda";
...
`),
        ...
        demoUsersHandler.addToRolePolicy(new iam.PolicyStatement({
            actions: [
...
`),
        ...
        const sampleProducts = [
            {
                ...
                description: "A best-selling paperback covering the rise of modern cloud computing.",
                category: "books",
                price: 19.99,
                stock: 100,
                imageUrl: "https://images.unsplash.com/photo-1512820790803-83ca734da794?auto=format&fit=crop&w=800&q=70",
            },
            {
                sku: "HEADPHONES-1",
                ...
                price: 89.99,
                stock: 50,
                imageUrl: "https://images.unsplash.com/photo-1518443895914-c5dc4f2ab57f?auto=format&fit=crop&w=800&q=70",
            },
            {
                sku: "MOUSE-1",
                ...
                price: 39.99,
                stock: 80,
                imageUrl: "https://images.unsplash.com/photo-1527864550417-7fd91fc51a46?auto=format&fit=crop&w=800&q=70",
            },
            {
                sku: "KEYBOARD-1",
                ...
                price: 119.99,
                stock: 40,
                imageUrl: "https://images.unsplash.com/photo-1587829741301-dc798b83add3?auto=format&fit=crop&w=800&q=70",
            },
            {
                sku: "WATCH-1",
                ...
                price: 199.99,
                stock: 25,
                imageUrl: "https://images.unsplash.com/photo-1546868871-7041f2a55e12?auto=format&fit=crop&w=800&q=70",
            },
            {
                sku: "TABLET-1",
                ...
                price: 299.99,
                stock: 20,
                imageUrl: "https://images.unsplash.com/photo-1561154464-82e9adf32764?auto=format&fit=crop&w=800&q=70",
            },
            {
                sku: "PHONE-1",
                name: "Nimbus 5G Smartphone",
                description: "Flagship smartphone with triple-lens camera and 256GB storage.",
                category: "electronics",
                price: 699.99,
                stock: 30,
                imageUrl: "https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?auto=format&fit=crop&w=800&q=70",
            },
            {
                sku: "MONITOR-1",
                ...
                price: 449.99,
                stock: 15,
                imageUrl: "https://images.unsplash.com/photo-1527443224154-c4a3942d3acf?auto=format&fit=crop&w=800&q=70",
            },
            {
                sku: "CAMERA-1",
                name: "Voyager Mirrorless Camera",
                description: "24MP mirrorless camera with interchangeable lens and 4K video.",
                category: "electronics",
                price: 899.99,
                stock: 12,
                imageUrl: "https://images.unsplash.com/photo-1519183071298-a2962be96e63?auto=format&fit=crop&w=800&q=70",
            },
            {
                sku: "LAPTOP-1",
                name: "Stratus 14 Laptop",
                description: "Slim 14-inch laptop with 16GB RAM, 512GB SSD, and all-day battery.",
                category: "electronics",
                price: 1199.99,
                stock: 10,
        ...
        orders.addMethod("POST", new apigw.LambdaIntegration(orderLambda), authMethodOpts);
        ...
        uploads
            ...
            .addMethod("POST", new apigw.LambdaIntegration(uploadLambda), authMethodOpts);
        // -----------------------------------------------------------------------
        // Stack outputs
        // -----------------------------------------------------------------------
